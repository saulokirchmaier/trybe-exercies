...
O ponto principal dessa aula foi entender as funcionalidades do HTML semântico, suas particularidades e utilizações.
Aprender sobre as tags **header**, **nav**, **aside**, **article**, **section**, **footer** e **img**, e como elas se comportam para a acessibilidade do código.


## Exercício

Para a aula foi proposto criar uma página sobre o Stomatopoda, cumprindo os requísitos:
...
7. Por fim foi pedido validar o HTML semântico e verificar sua acessibilidade no site [achecker](https://achecker.ca/checker/index.php#output_div).
    - Submeter o código
    - Verificar e entender os error 
    - Corrigir os error 
