...
const orderModifier = (order) => {
  ...
  const allItens = Object.keys(order.order.pizza);
  return `Olá ${order.name}, o total do seu pedido de ${allItens[0]}, ${allItens[1]}, e ${Object.values(order.order.drinks.coke)[0]} é de R$${order.payment.total},00.`;
}
